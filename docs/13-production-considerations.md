...
Hoy: `.env.example`, `AGENTS.md`, CI, `src/graph/`, `src/core/errors.ts`, `src/tools/registry.ts`, `src/observability/` y `src/evals/`. Más adelante: adapters de persistence, clasificación de errores de provider y normalización de usage/costos.
